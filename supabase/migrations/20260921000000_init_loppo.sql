-- ==============================================================================
-- Loppo Platform: Supabase Migration (Initial Schema & RLS Policies)
-- Description: Modern social platform schema with full Row Level Security (RLS)
-- ==============================================================================
...
-- 3. POST LIKES (Normalized upvotes)
