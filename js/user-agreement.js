...
const translations = {
    en: {
        ...
        agreementLastUpdated: 'Last updated: 2026',
    ...
    ar: {
        ...
        agreementLastUpdated: 'آخر تحديث: 2026',
        section1Title: '1. قبول الشروط',
        section1Text: 'باستخدامك لمنصة لوبو، فإنك توافق على الالتزام باتفاقية المستخدم هذه وجميع الشروط المضمنة فيها. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام المنصة.',
        section2Title: '2. حسابات المستخدمين',
        section2Text: 'أنت مسؤول عن الحفاظ على سرية بيانات حسابك. توافق على تحمل المسؤولية عن جميع الأنشطة التي تحدث تحت حسابك. يجب أن يكون عمرك 13 سنة على الأقل لاستخدام لوبو.',
        section3Title: '3. محتوى المستخدم',
        section3Text: 'تحتفظ بملكية أي محتوى تنشره على لوبو. بنشر المحتوى، تمنح لوبو ترخيصاً غير حصري لعرض وتوزيع المحتوى الخاص بك على المنصة. أنت وحدك المسؤول عن المحتوى الذي تنشره.',
        ...
        section6Text: 'يتم توفير لوبو "كما هو" دون أي ضمانات من أي نوع. نحن لا نضمن أن المنصة ستكون دون انقطاع أو خالية من الأخطاء.',
        section7Title: '7. تحديد المسؤولية',
        section7Text: 'إلى أقصى حد يسمح به القانون، لا يتحمل لوبو المسؤولية عن أي أضرار غير مباشرة أو عرضية أو تبعية ناتجة عن استخدامك للمنصة.',
        section8Title: '8. التعديلات على الاتفاقية',
        section8Text: 'يجوز لنا تعديل هذه الاتفاقية في أي وقت. الاستمرار في استخدام لوبو بعد التعديلات يعني قبولك للشروط المعدلة.',
        ...
        agreeBtn: 'أوافق',
        declineBtn: 'أرفض',
        acceptMessage: 'شكراً لقبولك الشروط. يمكنك الآن متابعة استخدام لوبو.',
        declineMessage: 'يجب عليك قبول اتفاقية المستخدم للمتابعة في استخدام لوبو.'
    }
};
